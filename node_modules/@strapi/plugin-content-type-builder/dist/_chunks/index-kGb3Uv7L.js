...
const index$1 = require("./index-2letZnGH.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-MrKg2zR1.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-MrKg2zR1.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-kGb3Uv7L.js.map
