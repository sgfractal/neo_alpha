...
const ListView$1 = lazy(() => import("./ListView-WcZ50hy8.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-WcZ50hy8.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-cwaaH1xV.mjs.map
