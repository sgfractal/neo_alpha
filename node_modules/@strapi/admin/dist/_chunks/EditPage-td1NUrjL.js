...
const useWebhooks = require("./useWebhooks-zLYIHzzh.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-OWYW5HQM.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-td1NUrjL.js.map
