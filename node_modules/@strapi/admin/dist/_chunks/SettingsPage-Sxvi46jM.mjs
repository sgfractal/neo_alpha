...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-UeIeOkVZ.mjs";
import sortBy from "lodash/sortBy";
import { useSelector } from "react-redux";
import { s as selectAdminPermissions } from "./AuthenticatedApp-6PK_F-W8.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-1OrCvfdr.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-5czXFp0v.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-y_NlYL1v.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-VedCfTQ4.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-QlgoDauY.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-V2BAPKdS.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-N8B_PcOh.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-fwjKIxrj.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-kx5DbEVo.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-j6T-iIOQ.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-Xy3CIe-W.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-JRAZ-tDi.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-4TaabJAu.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-Q1k1R-o6.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-6NyyYtJ9.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-U0-bpiCR.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-wDN3eCQN.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-Sxvi46jM.mjs.map
