...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-UeIeOkVZ.mjs";
...
import { u as useWebhooks } from "./useWebhooks-hKQKAFbS.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-0iuKZa4P.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-fwjKIxrj.mjs.map
