...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-UeIeOkVZ.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.14.1",
  "@strapi/permissions": "4.20.2",
  "@strapi/provider-audit-logs-local": "4.20.2",
  "@strapi/types": "4.20.2",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.20.2",
  "@strapi/data-transfer": "4.20.2",
  "@strapi/pack-up": "4.20.2",
  "@strapi/plugin-content-manager": "4.20.2",
...
const CM = React.lazy(
  () => import("./index-UeIeOkVZ.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-4IkbnZFB.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-5JgxesKb.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage--QAa2FwA.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-UeIeOkVZ.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-CRUmheJU.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-Sxvi46jM.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-6PK_F-W8.mjs.map
